...
namespace ThumbLib
{
    public class Converter
    {
        ...
        public static VideoFile GetVideoInfo(string inputPath)
        {
            VideoFile vf = null;
            try
            {
        ...
        public static void GetVideoInfo(VideoFile input)
        {
        ...
        public OutputPackage StrackImages(VideoFile input, int num)
        {
            ...
            Thread.Sleep(2000);
            ///////
            string[] files = Directory.GetFiles(this.WorkingPath, $"*.jpg");
        ...
        public OutputPackage MakeGif(VideoFile input, int num)
        {
            ...
            try
            {
                ...
                Params = $"-y -framerate {FrameRate} -i \"{finalpath}\"  \"{outfilegif}_thumbs_0000.gif\"";
                ...
                {
                    ou.VideoStream = LoadMemoryStreamFromFile($"{outfilegif}_thumbs_0000.gif");
                }
            ...
            //    catch (Exception) { }
            //}
            Debug.WriteLine($"create gif {outfilegif}_thumbs_0000.gif from {input.Path}");
            return ou;
        }
